...
export default function Hero() {
  return (
    ...
    >
      ...
      {/* ── DESKTOP ── flex layout: text left, statue right.
           RULE: archway top + base engravings must ALWAYS be visible.
           object-fit:contain guarantees the full image is never cropped. */}
      <div
      ...
      >
        ...
        {/* Right image column — statue fully visible, never cropped */}
        <div
          style={{
            width: '50%',
            position: 'relative',
